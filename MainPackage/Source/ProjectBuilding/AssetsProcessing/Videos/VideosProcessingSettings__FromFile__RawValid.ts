...
type VideosProcessingSettings__FromFile__RawValid = {
  readonly assetsGroups: { readonly [groupID: string]: VideosProcessingSettings__FromFile__RawValid.AssetsGroupSettings; };
};
...
namespace VideosProcessingSettings__FromFile__RawValid {
  ...
  export function getLocalizedPropertiesSpecification(
    namedParameters: {
      readonly videosProcessingLocalization: Localization;
    ...
    return AssetsProcessingSettingsGenericProperties__FromFile__RawValid.getLocalizedSpecification({
      ...namedParameters,
      assetsProcessingSettingsGenericPropertiesLocalization: namedParameters.videosProcessingLocalization
    });
  }
}
