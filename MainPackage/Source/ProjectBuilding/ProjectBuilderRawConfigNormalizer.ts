...
import ProjectBuildingDebuggingSettingsNormalizer from
    "./Debugging/ProjectBuildingDebuggingSettingsNormalizer";
import type MarkupProcessingSettings__Normalized from
    "@MarkupProcessing/MarkupProcessingSettings__Normalized";
import MarkupProcessingRawSettingsNormalizer from
    "@MarkupProcessing/MarkupProcessingRawSettingsNormalizer";
import type StylesProcessingSettings__Normalized from
    "@StylesProcessing/StylesProcessingSettings__Normalized";
import StylesProcessingRawSettingsNormalizer from
    "@StylesProcessing/StylesProcessingRawSettingsNormalizer";
