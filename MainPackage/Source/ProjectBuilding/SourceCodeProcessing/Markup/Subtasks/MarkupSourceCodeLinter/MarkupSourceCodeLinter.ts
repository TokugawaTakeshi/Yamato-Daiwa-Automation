...
import markupSourceCodeLinterLocalization__english from
    "@MarkupProcessing/Subtasks/MarkupSourceCodeLinter/MarkupSourceCodeLinterLocalization.english";
...
class MarkupSourceCodeLinter extends GulpStreamsBasedSourceCodeLinter {
    ...
    return (): NodeJS.ReadWriteStream => Gulp.
        ...
        pipe(gulpIf(
          ...
          (markupSourceFile: VinylFile): boolean =>
              this.hasLintingResultsBeenCachedForSpecificMarkupSourceFile(markupSourceFile),
  ...
  private hasLintingResultsBeenCachedForSpecificMarkupSourceFile(targetMarkupSourceFile: VinylFile): boolean {
