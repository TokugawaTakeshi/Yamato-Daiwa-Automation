...
export default abstract class ProductMocker {
  ...
  public static generate(
    ...
    const price__yen__includingTax: number =
        preDefinedFields.price__dollars__excludingTax ??
        getRandomInteger({
          minimalValue: Product.Price__Dollars__IncludingTax.MINIMAL_VALUE,
          maximalValue: Product.Price__Dollars__IncludingTax.MAXIMAL_VALUE
        });
    ...
    return {
      ...
      category,
      price__dollars__excludingTax: price__yen__includingTax
    };
